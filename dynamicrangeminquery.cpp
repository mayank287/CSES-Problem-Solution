...
// ll buildSegmentTree(ll start, ll end, ll index, ll arr[], ll tree[])
// {
//     if(start == end)
//     {
...
//     tree[index] = min(buildSegmentTree(start, mid, 2 * index + 1, arr, tree)
//                , buildSegmentTree(mid + 1, end, 2 * index + 2, arr, tree));
 
//     return tree[index];
// }
// ll getmin(ll queryStart, ll queryend, ll start, ll end, ll index, ll tree[])
// {
...
//     return min(getmin(queryStart, queryend, start, mid, 2 * index + 1, tree)
//            , getmin(queryStart, queryend, mid + 1, end, 2 * index + 2, tree));
// }
// void update(ll start, ll end,ll newIndex, ll index, ll diff, ll  tree[])
// {
...
//                 cin >> k >> u;
//                 ll diff = u - arr[k - 1];
//                 cout << " value = " << arr[k - 1] << " value of k= "  << k << endl;
//                arr[k - 1] = u;
//                update(0,n - 1,k - 1,0,diff,tree);
//             }
//           else
//           {
//             ll a,b;
//             cin >> a >> b;
//             cout <<  getmin(a - 1,b - 1,0,n - 1,0,tree) << "\n";
//           }
